...
export const metadata: Metadata = {
  ...
  title: "Name App - Find a Chinese name with meaning",
...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  const structuredData = { "@context": "https://schema.org", "@type": "WebSite", name: "Name App", url: "https://nameapp.uk", description: "A cultural and linguistic Chinese name atelier." };
